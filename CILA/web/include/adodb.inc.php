...
/** 
 * @version V1.51 5 Nov 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved.
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	 ...
	 */
	$ADODB_vers = 'V1.51 5 Nov 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	...
	* @return		the recordset ($rs->databaseType == 'array')
	...
	function &CacheExecute($secs2cache,$sql,$inputarr=false,$arg3=false)
	{
		...
		if ($inputarr) return $this->Execute($ql, $inputarr, $arg3); 
